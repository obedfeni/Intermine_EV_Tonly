...
const ROLES = [
  { value: 'WORKER', label: 'Worker', desc: 'View-only access to fleet data' },
  { value: 'TECHNICIAN', label: 'Technician', desc: 'Report faults & manage assigned tasks' },
  { value: 'SUPERVISOR', label: 'Supervisor', desc: 'Full access, schedule & assign tasks' },
  { value: 'CHARGING_OPERATOR', label: 'Charging Operator', desc: 'Log charging sessions & upload data' },
]
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 py-8">
      ...
      <div className="relative w-full max-w-md p-8 bg-slate-900/80 backdrop-blur-xl rounded-2xl border border-slate-700/50 shadow-2xl">
        <div className="flex flex-col items-center mb-6">
          ...
          <p className="text-slate-400 mt-1 text-sm">Join the Tonly Fleet team</p>
        </div>
